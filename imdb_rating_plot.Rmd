...
game_of_thrones %>% create_episode_plot("Game of Thrones") %>% plotly::ggplotly(tooltip = "text")
```
...
breaking_bad %>% create_episode_plot("Breaking Bad") %>% plotly::ggplotly(tooltip = "text")
```
...
avatar %>% create_episode_plot("Avatar: The Last Airbender") %>% plotly::ggplotly(tooltip = "text")
```
...
always_sunny %>% create_episode_plot("Always Sunny in Philadelphia") %>% plotly::ggplotly(tooltip = "text")
```
...
office %>% create_episode_plot("The Office (US)") %>% plotly::ggplotly(tooltip = "text")
```
...
himym %>% create_episode_plot("How I Met Your Mother") %>% plotly::ggplotly(tooltip = "text")
```
...
better_call_saul %>% create_episode_plot("Better Call Saul") %>% plotly::ggplotly(tooltip = "text")
```
...
zerozerozero %>% create_episode_plot("ZeroZeroZero") %>% plotly::ggplotly(tooltip = "text")
```
...
hotd %>% create_episode_plot("House of the Dragon") %>% plotly::ggplotly(tooltip = "text")
```
...
bluey %>% create_episode_plot("Bluey") %>% plotly::ggplotly(tooltip = "text")
```
...
westworld %>% create_episode_plot("Westworld") %>% plotly::ggplotly(tooltip = "text")
```
...
paris_hilton_bff %>% create_episode_plot("Paris Hilton's My New BFF") %>% plotly::ggplotly(tooltip = "text")
```
...
stranger_things %>% create_episode_plot("Stranger Things") %>% plotly::ggplotly(tooltip = "text")
```
...
bojack %>% create_episode_plot("Bojack Horseman") %>% plotly::ggplotly(tooltip = "text")
```
...
velma %>% create_episode_plot("Velma") %>% plotly::ggplotly(tooltip = "text")
```
...
suits %>% create_episode_plot("Suits") %>% plotly::ggplotly(tooltip = "text")
```
...
vampire_diaries %>% create_episode_plot("Vampire Diaries") %>% plotly::ggplotly(tooltip = "text")
```
...
mad_men %>% create_episode_plot("Mad Men") %>% plotly::ggplotly(tooltip = "text")
```
