...
ggplot2::ggsave("imdb_rating_plot_files/the_simpsons.png", plot = simpsons_gg, width = 16, height = 6, dpi = 300)
```
...
# resave here for the correct width
ggplot2::ggsave("imdb_rating_plot_files/south_park.png", plot = south_park_gg, width = 16, height = 6, dpi = 300)
```
...
# resave here for the correct width
ggplot2::ggsave("imdb_rating_plot_files/family_guy.png", plot = family_guy_gg, width = 16, height = 9, dpi = 300)
```
