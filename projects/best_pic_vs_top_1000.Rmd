...
output_file: "projects/best_pic_vs_top_1000.html"
---
...
```{r data}
oscar_winners_clean = read_csv(here::here("data", "best_picture_winners.csv"))

imdb_rank_ratings_clean = read_csv(here::here("data", "top1000_box_office.csv"))
```
