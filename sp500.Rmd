...
price_data = tq_get(x = "VOO", from = "2018-01-01", to = as.character(Sys.Date()), get = "stock.prices")
...
sp_intersections_plot = voo_full %>% 
  ...
  ggtitle("S&P 500")+
  ylab("Closing Price") +
  ggrepel::geom_text_repel(data = intersections_voo, aes(label = as.character(date), segment.color = "red"), box.padding = .5,
                           nudge_y = 10)
