...
resume = googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/13mLROsbvwiE-djiRMQuOKfQwppOlH5mOxB43EaGna8s")
resume %>% write.csv(here::here("data", "cv.csv"))
...
resume_v2 = resume_v1_1 %>% tidyr::pivot_longer(tidyselect::starts_with('description'),
