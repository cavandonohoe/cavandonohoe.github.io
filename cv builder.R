...
positions_collapsed_bullets_final %>% filter(section=="awards") %>% glue_data("### {title}", 
                                                                              "\n\n",
                                                                              "{institution}",
                                                                              "\n\n",
                                                                              "{location}",
...
render(input = "T:/Cavan/R Script/Test/cv builder.Rmd", output_file = "T:/Cavan/R Script/Test/cv-builder.html")
shell.exec("T:/Cavan/R Script/Test/cv-builder.html")
