...
Also, the largest single day increase from close to close was on `r max_date` with a single day jump of `r percent(max_change_perc - 1, accuracy = .1)`. So, keep investing and continue to buy the dip.
