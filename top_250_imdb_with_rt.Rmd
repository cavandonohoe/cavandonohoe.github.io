...
cat('
<meta property="og:title" content="Top 250 IMDb Movies with Rotten Tomatoes">
<meta property="og:description" content="Cross-referencing IMDb&#39;s top 250 movies with Rotten Tomatoes scores.">
<meta property="og:url" content="https://cavandonohoe.github.io/top_250_imdb_with_rt.html">
...
cat(sprintf(
  ...
  format(file.mtime(here::here("data", "top250_movies_with_rt.csv")), "%B %d, %Y")
))
```
