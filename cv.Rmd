...
positions_collapsed_bullets_final %>%
  ...
  dplyr::mutate(description_section = gsub("website", "[website](https://cavandonohoe.github.io/)", description_section),
...
positions_collapsed_bullets_final %>% dplyr::filter(section=="Experience") %>% glue::glue_data("### {title}", "\n\n",
                                                                    "{institution}",
                                                                    "\n\n",
                                                                    "{location}",
                                                                    "\n\n",
...
positions_collapsed_bullets_final %>% dplyr::filter(section=="Education") %>% glue::glue_data("### {title}", "\n\n",
                                                                    "{institution}",
                                                                    "\n\n",
                                                                    "{location}",
                                                                    "\n\n",
...
positions_collapsed_bullets_final %>% dplyr::filter(section=="Awards") %>% glue::glue_data("### {description_section}", 
                                                                              "\n\n",
                                                                              "{institution}",
                                                                              "\n\n",
                                                                              "{location}",
...
positions_collapsed_bullets_final %>% dplyr::filter(section=="Credentials") %>% glue::glue_data("### {description_section}", 
                                                                              "\n\n",
                                                                              "{institution}",
                                                                              "\n\n",
                                                                              "{location}",
