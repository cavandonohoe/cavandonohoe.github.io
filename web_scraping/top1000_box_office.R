...
get_rating <- function(link){
  link %>%
    ...
    # rvest::html_nodes(
    #   xpath = paste0(
    #     "//*[@id='__next']/main/div/section[1]/section/div[3]/section/section/div[1]/",
    #     "div[2]/div/div[1]/a/div/div/div[2]/div[1]/span[1]"
    #   )
    # ) %>%
    # new version
    rvest::html_nodes(paste0(
      "#__next > main > div > section.ipc-page-background.ipc-page-background--base.",
      "sc-ca85a21c-0.efoFqn > section > div:nth-child(4) > section > section > ",
      "div.sc-80d4314-0.fjPRnj > div.sc-db8c1937-0.eGmDjE.sc-80d4314-3.iBtAhY > ",
    ...
    rvest::html_nodes(paste0(
      "div.sc-7ab21ed2-0.fAePGh > div.sc-7ab21ed2-2.kYEdvH > ",
      "span.sc-7ab21ed2-1.jGRxWM"
    )) %>%
