...
```{r commit-activity, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 7, fig.path = "images/readme/", dev = "png", dpi = 110, fig.alt = "Two bar charts showing monthly commits and monthly lines changed (insertions + deletions) for this repository, split by Cavan's own commits vs. scheduled-bot commits."}
